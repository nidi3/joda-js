/*global timeZone,stdDate,LocalDate,DateTimeUtils,littleBefore,almostDayAfter,goodDayAfter,matchers,jodajs,beforeEach,describe,it,expect,window*/
describe("LocalDate", function () {

    describe("init", function () {
        it("should construct a LocalDate with given fields", function () {
            expect(LocalDate(2014, 2, 3).getYear()).toBe(2014);
            expect(LocalDate(2014, 2, 3).getMonthOfYear()).toBe(2);
            expect(LocalDate(2014, 2, 3).getDayOfMonth()).toBe(3);
        });
    });
    ...
    describe("toDate", function () {
        it("should return a Date with the same fields as the LocalDate (time fields set to 0)", function () {
            expect(LocalDate(2014, 2, 9).toDate()).toEqual(stdDate(2014, 1, 9, 0, 0, 0, 0));
        });
    });
